...
describe("getters", () => {
  ...
  describe("INCLUDE_JOB_BY_ORGANIZATION", () => {
    ...
    it("it identifies if job is associated with given organizations", () => {
      const userStore = useUserStore();
  ...
  describe("INCLUDE_JOB_BY_JOB_TYPE", () => {
    ...
    it("it identifies if job is associated with given job types", () => {
      const userStore = useUserStore();
  ...
  describe("INCLUDE_JOB_BY_SKILL", () => {
    it("idtentifies if job matches user's skills", () => {
      const userStore = useUserStore();
    ...
    it("handles inconsitent character casing", () => {
      const userStore = useUserStore();
      userStore.skillsSearchTerm = "vuE";
      const store = useJobsStore();
